...
4.4.2 Defining the model and its architecture:
...
4.4.4 Estimating the model’s performance: 
...
4.7.2 Example of HVPS for VGG16 model which is having 145 test classes
